...
def create_mock_teams():
    ...
    c = conn.cursor()
    c.execute("INSERT INTO teams VALUES (?, ?, ?, ?)", ("test team 1", "test1", helpers.hash_password("test1"), "test1@gmail.com"))
    c.execute("INSERT INTO teams VALUES (?, ?, ?, ?)", ("test team 2", "test2", helpers.hash_password("test2"), "test2@gmail.com"))
